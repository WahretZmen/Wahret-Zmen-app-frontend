      ...
      ar: {
        translation: {
         ...
         all: "الكل",
          ...
          our_sellers_intro_html: ".استكشفوا مجموعتنا من الملابس التقليدية المصنوعة بعناية وأصالة ثقافية. <strong>القفاطين</strong> الأنيقة إلى <strong>الجباب</strong> اكتشفوا جمال التراث في كل قطعة",
          ...
          about: {
            ...
            join_text2: ".ندعوكم لتجربة الأناقة الأصيلة بلمسة عصريّة من ,وهرة الزّمن"
          },
