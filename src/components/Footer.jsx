 ...
 * Footer
 * -------------------------------------------------
 * - Multilingual, RTL-aware footer.
 * - Sections: Brand/About, Quick Links, Contact Info, Socials.
    ...
    <footer className="bg-gray-200 text-gray-800 py-10 font-[Arial]" dir={i18n.dir()}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm font-normal text-gray-700">{t("footer.description")}</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className={iconTextClass}>
              ...
              <span className="text-gray-700 font-medium">{t("footer.location")}</span>
            </li>
            <li className={iconTextClass}>
        ...
        <div>
          ...
          <div
            className={`flex items-center mt-2 ${
              isRTL ? "justify-end gap-4 flex-row-reverse" : "gap-4"
            }`}
          >
            <a
            ...
            <a
              href="https://www.tiktok.com/@wahretzmenbysabri"
