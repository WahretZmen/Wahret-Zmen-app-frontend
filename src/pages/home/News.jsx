        ...
        <div className="news-slider-wrap">
          <Slider {...settings}>
            {newsItems.map((item, idx) => {
              ...
              const title = item?.title || t("news.fallback_title", { defaultValue: "Wahret Zmen News" });
              const description =
                item?.description ||
                t("news.fallback_desc", { defaultValue: "Discover our latest collections and atelier moments." });

              return (
                <div key={idx} className="news-slide">
                  <Link to="/" className="news-card-pro" aria-label={title}>
                    ...
                    <div className="news-body">
                      ...
                      <span className="news-cta">{t("news.read_more", { defaultValue: "Learn more" })} →</span>
                    </div>
                  </Link>
                </div>
              );
